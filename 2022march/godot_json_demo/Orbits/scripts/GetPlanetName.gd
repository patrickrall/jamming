...
var flavor_text = {
	...
	"Stilt": "The Millet planets all follow the same orbit, but out of sync, so millions of migrant workers travel between each of them in turn, reaping and planting when the season is right. This means that Millet is a huge agriculture powerhouse, able to churn out tons of food for cheap. The people who stay on-planet during the off seasons can be very off-putting. Meanwhile the underfed migrant workers are friendly, but they have no roots or education, often going generations without breaking the pattern. Stilt's river-laced surface waters its cotton plants and powers its looms.", 
	"Yard" : "The Millet planets all follow the same orbit, but out of sync, so millions of migrant workers travel between each of them in turn, reaping and planting when the season is right.	This means that the Millet system is a huge agriculture powerhouse, able to churn out tons of food for cheap. The people who stay on-planet during the off seasons can be very off-putting. Meanwhile the underfed migrant workers are friendly, but they have no roots or education, often going generations without breaking the pattern. Yard's soft soil is perfect for planting acres of wheat, corn, and other perennials.", 
	"Crash": "The Millet planets all follow the same orbit, but out of sync, so millions of migrant workers travel between each of them in turn, reaping and planting when the season is right. This means that Millet is a huge agriculture powerhouse, able to churn out tons of food for cheap. The people who stay on-planet during the off seasons can be very off-putting. Meanwhile the underfed migrant workers are friendly, but they have no roots or education, often going generations without breaking the pattern. Crash is covered in rolling grasslands, ideal for raising cattle.",
	...
	"Silt": "This planet has long days with low sunlight, perfect weather for its abundant sandy beaches. The people who live there spend their time surfing and sunbathing during the long days. During the long nights, they drink together in cities while nocturnal predators roam the shallows. ",
